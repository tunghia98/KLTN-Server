...
// const ORDER_RATED_STORAGE_KEY = "ratedOrders";
...
//   // Lấy ratedOrders từ localStorage lần đầu component mount
//   const [ratedOrders, setRatedOrders] = useState(() => {
//     const saved = localStorage.getItem(ORDER_RATED_STORAGE_KEY);
...
//     if (ratingOrder !== null) {
//       // Cập nhật ratedOrders và lưu vào localStorage
//       setRatedOrders((prev) => {
//         const newRatedOrders = [...prev, ratingOrder];
//         localStorage.setItem(
//           ORDER_RATED_STORAGE_KEY,
//           JSON.stringify(newRatedOrders)
//         );
//         return newRatedOrders;
//       });
//     }
//   };
...
//                 </button>
//               )}
//               {order.status === "Đã giao" && !ratedOrders.includes(order.id) && (
//                 <button
//                   className="btn btn-review"
//                   onClick={() => handleRating(order.id)}
//                 >
...
//         >
//           <p>
//             Bạn có chắc chắn muốn hủy đơn hàng <strong>{selectedOrderId}</strong> không?
//           </p>
//           <div className="popup-actions">
//             <button className="btn btn-confirm" onClick={handleConfirmCancel}>
//               Xác nhận
