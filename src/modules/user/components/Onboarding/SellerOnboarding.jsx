    ...
    const handleComplete = async () => {
        ...
        try {
            ...
            if (shopAvatar) {
                ...
                const uploadAvatarResponse = await fetch(`${baseUrl}/api/shops/upload-shop-avatar`, {
                    method: "POST",
                    headers: {
                        Authorization: `Bearer ${localStorage.getItem("accessToken")}`,
                    },
            ...
            // 3. Thêm địa chỉ shop
            const addAddressResponse = await fetch(`${baseUrl}/api/addresses/shop/${shopId}`, {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                    Authorization: `Bearer ${localStorage.getItem("accessToken")}`,
    ...
    return (
        ...
        {steps.map((label, index) => (
            ...
            <div>
                ...
                />
                {previewAvatar && (
                <img src={previewAvatar} alt="Shop Avatar" style={{ maxWidth: "150px", borderRadius: "8px", marginTop: "10px" }} />
                )}
            </div>
